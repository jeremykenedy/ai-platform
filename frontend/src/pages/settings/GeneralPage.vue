...
import { User, Mail, Globe, Lock, Camera, CheckCircle, AlertCircle, Loader2 } from 'lucide-vue-next'
...
function validateProfile() {
  ...
  else if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(profile.email)) profileErrors.email = 'Enter a valid email.'
...
function validateSecurity() {
  ...
  if (!security.current_password) securityErrors.current_password = 'Current password is required.'
  if (!security.new_password) securityErrors.new_password = 'New password is required.'
  else if (security.new_password.length < 8) securityErrors.new_password = 'Password must be at least 8 characters.'
  if (!security.confirm_password) securityErrors.confirm_password = 'Please confirm your password.'
  else if (security.new_password !== security.confirm_password) securityErrors.confirm_password = 'Passwords do not match.'
  ...
  <div class="max-w-2xl mx-auto p-6 space-y-8">
    ...
    <section class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-5">
      ...
      <div class="flex items-center gap-5">
        ...
        >
          ...
          <span
            v-else
            class="text-xl font-bold text-indigo-600 dark:text-indigo-300 select-none"
          >{{ userInitials || '?' }}</span>
          <span
      ...
      <div>
        ...
        <input
          ...
          :class="profileErrors.name ? 'border-red-400 dark:border-red-500' : 'border-gray-300 dark:border-gray-600'"
      ...
      <div>
        ...
        <div class="relative">
          ...
          <input
            ...
            :class="profileErrors.email ? 'border-red-400 dark:border-red-500' : 'border-gray-300 dark:border-gray-600'"
    ...
    <section class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-5">
      ...
      <div>
        ...
        <p v-if="localizationErrors.timezone" class="mt-1 text-xs text-red-500 flex items-center gap-1">
      ...
      <div>
        ...
        <p v-if="localizationErrors.locale" class="mt-1 text-xs text-red-500 flex items-center gap-1">
    ...
    <section class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-5">
      ...
      <p class="text-sm text-gray-500 dark:text-gray-400">Change your account password. You will need to enter your current password to confirm.</p>
      ...
      <div>
        ...
        <input
          ...
          class="w-full rounded-lg border px-3 py-2 text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
          :class="securityErrors.current_password ? 'border-red-400 dark:border-red-500' : 'border-gray-300 dark:border-gray-600'"
          placeholder="Enter current password"
        />
        <p v-if="securityErrors.current_password" class="mt-1 text-xs text-red-500 flex items-center gap-1">
      ...
      <div>
        ...
        <input
          ...
          class="w-full rounded-lg border px-3 py-2 text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
          :class="securityErrors.new_password ? 'border-red-400 dark:border-red-500' : 'border-gray-300 dark:border-gray-600'"
          placeholder="At least 8 characters"
        />
        <p v-if="securityErrors.new_password" class="mt-1 text-xs text-red-500 flex items-center gap-1">
      ...
      <div>
        ...
        <input
          ...
          autocomplete="new-password"
          class="w-full rounded-lg border px-3 py-2 text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
          :class="securityErrors.confirm_password ? 'border-red-400 dark:border-red-500' : 'border-gray-300 dark:border-gray-600'"
          placeholder="Repeat new password"
        />
        <p v-if="securityErrors.confirm_password" class="mt-1 text-xs text-red-500 flex items-center gap-1">
