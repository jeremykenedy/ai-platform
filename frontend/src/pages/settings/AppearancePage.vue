...
import { Sun, Moon, Monitor, Type, Rows3, Hash, CornerDownLeft, CheckCircle, Loader2 } from 'lucide-vue-next'
      ...
      <div class="grid grid-cols-3 gap-4">
        ...
        >
            ...
            <div class="w-full h-full flex" :class="t.preview.bg">
              ...
              <div class="flex-1 flex flex-col">
                ...
                <div class="flex-1 flex flex-col justify-end gap-1 p-1.5">
                  ...
                  <div class="w-12 h-3 rounded text-[4px] flex items-center px-1" :class="t.preview.message">
          ...
          <div class="flex items-center gap-1.5">
            ...
            >
              <div v-if="form.theme === t.value" class="w-1.5 h-1.5 rounded-full bg-indigo-600 dark:bg-indigo-400" />
            </div>
    ...
    <section class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-5">
      ...
      <div>
        <div class="flex items-center justify-between mb-1">
          ...
          <span class="text-xs font-mono text-gray-500 dark:text-gray-400">{{ form.font_size }}px</span>
        </div>
        <input
        ...
        >
          This is a live preview of your selected font size. The quick brown fox jumps over the lazy dog.
        </div>
      </div>
    </section>
      ...
      <div class="flex items-start gap-4">
        ...
        <div class="flex items-start gap-2">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Reduces padding and spacing between messages for a denser layout.</p>
          </div>
        </div>
      </div>
      ...
      <div class="flex items-start gap-4">
        ...
        <div class="flex items-start gap-2">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Display token usage below each message. Useful for monitoring costs.</p>
          </div>
        </div>
      </div>
        ...
        <div class="flex items-start gap-2">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
              {{ form.send_on_enter ? 'Press Enter to send. Use Shift+Enter for a new line.' : 'Press Shift+Enter to send. Enter adds a new line.' }}
            </p>
          </div>
        </div>
      </div>
