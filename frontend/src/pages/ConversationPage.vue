...
<template>
  <div class="flex flex-1 flex-col overflow-hidden">
    ...
    >
      <div class="flex h-14 w-14 items-center justify-center rounded-2xl bg-red-100 dark:bg-red-950/40">
        <AlertCircle class="h-7 w-7 text-red-500 dark:text-red-400" />
      </div>
      <div class="text-center">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Conversation not found</h2>
    ...
    <template v-else>
      <!-- Header -->
      <div class="flex shrink-0 items-center gap-2 border-b border-border bg-background/95 px-4 py-2.5 backdrop-blur-sm dark:border-border dark:bg-background/95">
        <!-- Inline title -->
