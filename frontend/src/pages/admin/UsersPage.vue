<script setup>
  ...
  import { Search, UserPlus, ChevronDown, X, Copy, Check } from 'lucide-vue-next'
...
<template>
    ...
    >
      ...
      <template v-else>
              ...
              >
                <td class="px-5 py-3">
                  <div class="flex items-center gap-3">
                    <div
                      class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-violet-600 text-xs font-semibold text-white uppercase"
                    >
                      {{ getInitials(u.name) }}
                    </div>
                ...
                <td class="px-5 py-3">
                  <div class="relative inline-block">
                    ...
                    <ChevronDown
                      class="pointer-events-none absolute right-1.5 top-1/2 -translate-y-1/2 h-3 w-3 opacity-60"
                    />
                  </div>
                </td>
        ...
        <ul class="md:hidden divide-y divide-gray-100 dark:divide-gray-800">
          <li v-for="u in users" :key="u.id" class="flex items-start gap-3 px-4 py-3">
            <div
              class="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-violet-600 text-xs font-semibold text-white uppercase"
            >
              {{ getInitials(u.name) }}
            </div>
        ...
        <div
          v-if="nextCursor"
          class="border-t border-gray-100 dark:border-gray-800 px-5 py-3 text-center"
        >
          <button
  ...
  <Teleport to="body">
    <div v-if="showInviteModal" class="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        class="relative w-full max-w-md rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-2xl"
      >
        <div
          class="flex items-center justify-between border-b border-gray-200 dark:border-gray-800 px-6 py-4"
        >
        ...
        <div class="px-6 py-5 space-y-4">
          ...
          <template v-if="inviteUrl">
            ...
            <div
              class="flex items-center gap-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-3 py-2"
            >
