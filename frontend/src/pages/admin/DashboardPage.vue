  ...
  <div class="space-y-6">
    ...
    <template v-else>
      ...
      <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-5">
          <div class="flex items-center justify-between mb-3">
            ...
            <div class="flex h-9 w-9 items-center justify-center rounded-lg bg-orange-50 dark:bg-orange-900/30">
      ...
      <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-5">
          <div class="flex items-center justify-between mb-3">
            ...
            <div class="flex h-9 w-9 items-center justify-center rounded-lg bg-teal-50 dark:bg-teal-900/30">
        ...
        <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-5">
          ...
          <p class="mt-1 text-xs" :class="stats.queue_failed > 0 ? 'text-red-600 dark:text-red-400' : 'text-gray-500 dark:text-gray-400'">
        ...
        <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-5">
          <div class="flex items-center justify-between mb-3">
            ...
            <div class="flex h-9 w-9 items-center justify-center rounded-lg bg-sky-50 dark:bg-sky-900/30">
        ...
        <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-5">
          <div class="flex items-center justify-between mb-3">
            ...
            <div class="flex h-9 w-9 items-center justify-center rounded-lg bg-pink-50 dark:bg-pink-900/30">
      ...
      <div class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
        ...
        <div v-if="activity.length === 0" class="px-5 py-10 text-center text-sm text-gray-500 dark:text-gray-400">
          No recent activity
        </div>
        ...
        <ul v-else class="divide-y divide-gray-100 dark:divide-gray-800">
          ...
          >
            <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-gray-200 dark:bg-gray-700 text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase">
            ...
            <div class="min-w-0 flex-1">
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{{ formatRelativeTime(entry.created_at) }}</p>
            </div>
          </li>
        </ul>
      </div>
