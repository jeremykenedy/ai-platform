  ...
  >
    ...
    <div v-if="files.length" class="mb-2 flex flex-wrap gap-2">
      ...
      >
        ...
        <span class="max-w-[120px] truncate text-foreground dark:text-foreground">{{ file.name }}</span>
        <button
    ...
    <!-- Input row -->
    <div class="flex items-end gap-2 rounded-xl border bg-muted/50 px-3 py-2 transition-colors dark:bg-muted/30"
    ...
    <div class="mt-1 flex items-center justify-between px-1 text-xs text-muted-foreground dark:text-muted-foreground">
