...
class GroqProvider extends AbstractAiProvider
{
    ...
    {
        parent::__construct('https://api.groq.com/openai');
    ...
    {
        throw new \RuntimeException('GroqProvider does not support embeddings.');
    }
    ...
    public function listModels(): array
    {
        try {
            ...
            Log::warning('[GroqProvider] listModels failed: '.$e->getMessage());
