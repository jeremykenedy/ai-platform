...
class OpenRouterProvider extends AbstractAiProvider
{
    ...
    {
        parent::__construct('https://openrouter.ai/api');

        $this->apiKey = (string) config('services.openrouter.api_key', '');
        $this->appUrl = (string) config('services.openrouter.app_url', '');
        $this->appName = (string) config('services.openrouter.app_name', 'AI Platform');
